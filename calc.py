...
def button_frct():
    ...
    if "." in str(e.get()):
        v = e.get()
        global frct
        frct = Fraction(v).limit_denominator()
        e.delete(0, END)
        e.insert(0, frct)
...
button_add = Button(root, text="+", padx=39, pady=20, font=helv36, command=button_add)
button_equal = Button(root, text="=", padx=91, pady=20, font=helv36, command=button_equal)
button_clear = Button(root, text="clear", padx=79, pady=20, font=helv36, command=button_clear)
button_subtract = Button(root, text="—", padx=41, pady=20, font=helv36, command=button_subtract)
button_multiply = Button(root, text="*", padx=40, pady=20, font=helv36, command=button_multiply)
button_divide = Button(root, text="/", padx=41, pady=20, font=helv36, command=button_divide)
button_remainder = Button(root, text="%", padx=41, pady=20, font=helv36, command=button_remainder)
button_frct = Button(root, text="frct<=>decimal", padx=39, pady=20, font=helv36, command=button_frct)
...
button_remainder.grid(row=7, column=0)
button_frct.grid(row=7, column=1, columnspan=2)
root.mainloop()
